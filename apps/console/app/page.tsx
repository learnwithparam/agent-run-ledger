...
import { formatCostPerThousand, humanMs, listRuns } from '@/lib/ledger.ts'
						...
						<tbody>
							{runs.map((run) => (
								<tr key={run.id}>
									...
									<td className="num">{formatCostPerThousand(run.tokensIn, run.tokensOut, run.costMinor, run.currency)}</td>
